...
<head>
    <meta charset="UTF-8">
    <title>Авторы научных трудов</title>
    ...
    <script>
        ...
        function submitFunc() {
            ...
            document.getElementById('works').value = arr1String;
...
<div class="form-style-2">
    <div class="form-style-2-heading"><font color="white">
            Авторы учебных трудов
        </font></div>

    <div class="b-container">
        <button class="bot1" onclick="PopUpShow(1)">Добавить научный труд</button>
    </div>
    <div class="b-container">
    ...
    <div class="b-popup" id="popup1" style="overflow: scroll;">
        <div class="b-popup-content">
            <table>
                ...
                <#list works as work>
                    <tr>
                        <td class="round-top">${work.getNameOfWork()}</td>
                        <td>${work.getTypeOfWork()}</td>
                        <td>${work.getYearOfPublication()}</td>
                        <td><input type="checkbox" name="check1" onclick="block(this)" style="zoom: 2" id="${work.getId()}"></td>
                    </tr>
                </#list>
            </table>
    ...
    <form method="post">
        <input type="text" id="works" name="works" hidden>
