...
<!-- NAVBAR -->
        <h2 align="center" style="margin-top: 20px">Работники АССОИ</h2>
        <form method="post">
            <div class="form-style-2">
            <label for="experience">Поиск по фамилии
        ...
        <table style="margin-top: 50px" align="center" class="table">
            ...
            <#list workers as worker>
                ...
                <td class="td">${worker.getPosition()}</td>
                    <td class="td"><a href="/getWorkerPage/${worker.getId()}">Личный профиль</a></td>
                </tr>
            </#list>
        </table>
        </form>
