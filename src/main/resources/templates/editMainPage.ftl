...
<div style="margin-top: 20px">
    <h2 style="margin-left: 20px">Редактирование</h2>
    <ul class="circle" style="margin-top: 10px">
        <hr class="disck"><li><a href="/getAllWorkersPage" style="font-size: 30px">Работники</a></li>
        <hr class="disck"><li><a href="/studentList" style="font-size: 30px">Студенты</a></li>
        <hr class="disck"><li><a href="/eduWorkEditList" style="font-size: 30px">Учебные труды</a></li>
        <hr class="disck"><li><a href="/scWorkEditList" style="font-size: 30px">Научные труды</a></li>
        <hr class="disck"><li><a href="/conferenceEditList" style="font-size: 30px">Конференции</a></li>
        <hr class="disck"><li><a href="/getPropList" style="font-size: 30px">Инт собственности</a></li>
        <hr class="disck"><li><a href="/getQualificationList" style="font-size: 30px">Квалификации</a></li>
        <hr class="disck"><li><a href="/getCandidateEditList" style="font-size: 30px">Кандидатские | Докторские</a></li>
    </ul>
    <br>
</div>
