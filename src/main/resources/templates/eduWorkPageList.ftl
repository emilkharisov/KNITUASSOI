...
<!-- NAVBAR -->
<h2 align="center" style="margin-top: 20px">Учебные работы</h2>
<form method="post">
    <div class="form-style-2">
        <label for="year">Поиск по году публикации
    ...
    <table style="margin-top: 50px" align="center" class="table">
        ...
        <#list works as work>
            <tr>
                ...
                <td class="td">${work.getTypeOfWork()}</td>
                <td class="td">${work.getYearOfPublication()}</td>
                <td class="td"><a href="/eduWorkPage/${work.getId()}">Информация</a></td>
            </tr>
        </#list>
    </table>
</form>
