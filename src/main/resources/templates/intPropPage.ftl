...
<table cellpadding="20">
    <tr>
        <td>
            <img src="/static/img/intProp.png" class="round" width="300px" height="300px">
            <table style="margin-left: 70px">
                <tr>
                    <td><button onclick="location.href='http://localhost:8080/deleteProp/${prop.getId()}'"><img src="/static/img/trashButton.png" height="60px" width="60px"></button></td>
                    <td><button onclick="location.href='http://localhost:8080/changeProp/${prop.getId()}'"><img src="/static/img/changeButton.png" height="60px" width="60px"></button></td>
                </tr>
            </table>
        </td>
        <td>
            <h2 style="margin-left: 20px">${prop.getName()}</h2>
            <table cellpadding="20" class="classTable">
                <tr>
                    <td><label>Вид документа</label></td>
                    <td>${prop.getTypeOfDocument()}</td>
                </tr>
                <tr>
                    <td><label>Объект</label></td>
                    <td>${prop.getObject()}</td>
                </tr>
                <tr>
                    <td><label>Регистрационный номер</label></td>
                    <td>${prop.getRegistrationNumber()}</td>
                </tr>
                <tr>
                    <td><label>№ заявки</label></td>
                    <td>${prop.getNumberOfDocument()}</td>
                </tr>
                <tr>
                    <td><label>Правообладатель</label></td>
                    <td>${prop.getOwner()}</td>
                </tr>
                <tr>
                    <td><label>Дата публикации</label></td>
                    <td>${prop.getDateOfPublicationShow()}</td>
                </tr>
                <tr>
                    <td><label>Дата регистрации</label></td>
                    <td>${prop.getDateOfAssignmentShow()}</td>
                </tr>
                <tr>
                    <td><label>Приоритет</label></td>
                    <td>${prop.getDateOfPriorityShow()}</td>
                </tr>
                <tr>
                    <td><label>Дата окончания</label></td>
                    <td>${prop.getDateOfExpirationShow()}</td>
                </tr>
            </table>
        </td>
        <td>
