...
<table cellpadding="20">
    <tr>
        <td>
            <img src="/static/img/books.png" class="round" width="300px" height="300px">
            <table style="margin-left: 70px">
                <tr>
                    <td><button onclick="location.href='http://localhost:8080/deleteEduWork/${work.getId()}'"><img src="/static/img/trashButton.png" height="60px" width="60px"></button></td>
                    <td><button onclick="location.href='http://localhost:8080/changeEduWork/${work.getId()}'"><img src="/static/img/changeButton.png" height="60px" width="60px"></button></td>
                </tr>
            </table>
        </td>
        <td>
        <h2 style="margin-left: 20px">${work.getNameOfWork()}</h2>
        <table cellpadding="20" class="classTable">
            <tr>
                <td><label>Тип работы</label></td>
                <td>${work.getTypeOfWork()}</td>
            </tr>
            <tr>
                <td><label>Количество страниц</label></td>
                <td>${work.getAmountOfPages()}</td>
            </tr>
            <tr>
                <td><label>Год издания</label></td>
                <td>${work.getYearOfPublication()}</td>
            </tr>
            <tr>
                <td><label>Издательство</label></td>
                <td>${work.getPublishing()}</td>
            </tr>
        </table>
        </td>
        <td>
