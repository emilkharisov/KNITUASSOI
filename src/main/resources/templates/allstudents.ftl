...
<!-- NAVBAR -->
<h2 align="center" style="margin-top: 20px">Студенты АССОИ</h2>
<form method="post">
    ...
    <table style="margin-top: 50px" align="center" class="table">
        <tr>
            ...
            <th class="th">Форма образования</th>
            <th class="th">Учебная группа</th>
        </tr>
        <#list students as student>
            <tr>
                <td class="td">${student.getFirstname()}</td>
                <td class="td">${student.getLastname()}</td>
                <td class="td">${student.getTelephone()}</td>
                <td class="td">${student.getFormOfEducation()}</td>
                <td class="td">${student.getEducationGroup()}</td>
                <td class="td"><a href="/studentPage/${student.getId()}">Информация</a></td>
            </tr>
        </#list>
    </table>
</form>
