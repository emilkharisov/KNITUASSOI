...
<head>
    <meta charset="UTF-8">
    <title>Редактирование конференций</title>
            ...
            <td>
                <table cellpadding="20">
                    <tr>
                        ...
                        <td>
                            <input class="input-field" id="name" name="name" maxlength="20" value="${conference.getName()}">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="date" id="dateOfStart" name="dateOfStart" class="data-field" value="${startDate}">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="date" id="dateOfEnd" name="dateOfEnd" class="data-field" value="${endDate}">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input class="input-field" id="city" name="city" maxlength="20" value="${conference.getCity()}">
                        </td>
                    </tr>
                    <tr>
                        <td>
