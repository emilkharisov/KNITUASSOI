...
<head>
    ...
    <script>
        ...
        function submitFunc() {
            ...
            document.getElementById('intellectualProperty').value = arr1String;
...
<div class="form-style-2">
    <div class="form-style-2-heading"><font color="white">
            Добавьте авторов инт.собственности
        </font></div>

    <div class="b-container">
        <button class="bot1" onclick="PopUpShow(1)">Добавить интеллектуальную собственность</button>
    </div>
    <div class="b-container">
        <button class="bot1" onclick="PopUpShow(2)">Добавить авторов</button>
    </div>
            ...
            <table>
                ...
                <#list conferences as conference>
                    <tr>
                        ...
                        <td>${conference.getOwner()}</td>
                        <td><input type="checkbox" name="check1" onclick="block(this)" style="zoom: 2" id="${conference.getName()}|${conference.getOwner()}"></td>
                    </tr>
                </#list>
            </table>
    ...
    <form method="post">
        <input type="text" id="intellectualProperty" name="intellectualProperty" hidden>
