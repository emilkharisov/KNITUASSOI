...
<table cellpadding="20">
    <input type="hidden" name="studentId" id="studentId" value="${student.getId()}">
    <tr>
        <td>
            <img src="/static/img/studentImage.png" class="round" width="300px" height="300px">
            <table style="margin-left: 70px">
                <tr>
                    <td><button onclick="location.href='http://localhost:8080/deleteStudent/${student.getId()}'"><img src="/static/img/trashButton.png" height="60px" width="60px"></button></td>
                    <td><button onclick="location.href='http://localhost:8080/changeStudent/${student.getId()}'"><img src="/static/img/changeButton.png" height="60px" width="60px"></button></td>
                </tr>
            </table>
        </td>
        <td>
        <h2 style="margin-left: 20px">${student.getLastname()} ${student.getFirstname()} ${student.getThirdname()}</h2>
        <table cellpadding="20" class="classTable">
            <tr>
                <td><label>Уровень образования</label></td>
                <td>${student.getEducationLevel()}</td>
            </tr>
            <tr>
            ...
            <tr>
                <td><label>Форма обучения</label></td>
                <td>${student.getFormOfEducation()}</td>
            </tr>
            <tr>
                <td><label>Направление</label></td>
                <td>${student.getDirection()}</td>
            </tr>
        </table>
        </td>
        <td>
