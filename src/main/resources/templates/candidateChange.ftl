...
<head>
    <meta charset="UTF-8">
    <title>Редактирование кандидатских, докторских</title>
    ...
    <script>
        $(document).ready(function(){
            ...
            var type = '${candidateWork.getType()}';
            ...
            <td>
                <table cellpadding="20">
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="input-field" id="name" name="name" value="${candidateWork.getName()}">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="date" id="date" name="date" class="data-field" value="${date}">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input class="input-field" id="numberOfDocument" name="numberOfDocument"  value="${candidateWork.getNumberOfDocument()}">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input class="input-field" id="sciences" name="sciences"  value="${candidateWork.getSciences()}">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input class="input-field" id="specialization" name="specialization"  value="${candidateWork.getSpecialization()}">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label>Место защиты</label>
                        </td>
                        <td>
                            <input class="input-field" id="place" name="place"  value="${candidateWork.getPlace()}">
                        </td>
                    </tr>
                    <tr>
