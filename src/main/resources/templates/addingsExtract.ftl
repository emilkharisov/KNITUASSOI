...
<div style="margin-top: 20px">
    ...
    <ul class="circle" style="margin-top: 10px">
        <hr class="disck"><li><a href="/getQualificationAfter">Выборка преподавателей, у которых не было повышения квалификации за n лет</a></li>
        <hr class="disck"><li><a href="/getQualificationReport">Выборка преподавателей, у которых были повышения квалификации за n лет</a></li>
