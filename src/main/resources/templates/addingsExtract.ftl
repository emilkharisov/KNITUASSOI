...
<div style="margin-top: 20px">
    <h2 style="margin-left: 20px">Выгрузка по студентам</h2>
    <ul class="circle" style="margin-top: 10px">
        <hr class="disck"><li><a href="/getStudentWorks">Выборка по работам студентов</a></li>
    </ul>
</div>
<div style="margin-top: 20px">
    <h2 style="margin-left: 20px">Выгрузка по публикациям</h2>
    <ul class="circle" style="margin-top: 10px">
        <hr class="disck"><li><a href="/getPublicationReport">Выборка публикаций по году</a></li>
    </ul>
</div>
<div style="margin-top: 20px">
    <h2 style="margin-left: 20px">Выгрузка по конференциям</h2>
    <ul class="circle" style="margin-top: 10px">
        <hr class="disck"><li><a href="/getСonfExctract">Выборка участников конференций по году</a></li>
    </ul>
</div>
<div style="margin-top: 20px">
    <h2 style="margin-left: 20px">Выгрузка по квалификациям</h2>
    <ul class="circle" style="margin-top: 10px">
        <hr class="disck"><li><a href="/getQualificationAfter">Выборка преподователей, у которых не было повышения квалификации за n лет</a></li>
        <hr class="disck"><li><a href="/getQualificationReport">Выборка преподователей, у которых были повышения квалификации за n лет</a></li>
