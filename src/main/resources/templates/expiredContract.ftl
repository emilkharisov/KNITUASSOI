...
<div class="form-style-2">
    <div class="form-style-2-heading"><font color="white"></font>
            Выборка преподователей по истеканию контракта
    </div>
    <form method="post" action="/selectExpiringContractWorkers">
        <table>
            <tr>
                <td> <input type="submit" value="Вывести преподователей на следующий год"></td>
                <td><input type="button" value="Вывести преподователей на текущий год" onclick="location.href='http://localhost:8080/selectExpiringContractWorkers'"></td>
            </tr>
        </table>
        <br>
