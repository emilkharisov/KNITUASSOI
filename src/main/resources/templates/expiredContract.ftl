...
<div class="form-style-2">
    <div class="form-style-2-heading"><font color="white"></font>
            Выборка преподавателей по истечению контракта
    </div>
    <form method="post" action="/selectExpiringContractWorkers">
        <table>
            <tr>
                <td> <input type="submit" value="Вывести преподавателей на следующий год"></td>
                <td><input type="button" value="Вывести преподавателей на текущий год" onclick="location.href='http://localhost:8080/selectExpiringContractWorkers'"></td>
            </tr>
        </table>
        <br>
        <table style="margin-top: 50px" align="center" class="table">
            <tr>
                ...
                <th class="th">Дата окончания контракта</th>
            </tr>
            <#list workers as worker>
                ...
                <td class="td">${worker.getPosition()}</td>
                    <td class="td">${worker.getDateEndOfContractShow()}</td>
                </tr>
            </#list>
        </table>
    </form>
