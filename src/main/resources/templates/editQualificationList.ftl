...
<!-- NAVBAR -->
<h2 align="center" style="margin-top: 20px">Квалификации</h2>
<form method="post">
    <div class="form-style-2">
        <label for="year">Поиск по программе
    ...
    <table style="margin-top: 50px" align="center" class="table">
        <tr>
            <th class="th">Программа</th>
            <th class="th">Дата начала</th>
            <th class="th">Дата окончания</th>
            <th class="th">Организация</th>
        </tr>
        <#list qualificationList as qualification>
            <tr>
                <td class="td">${qualification.getProgramm()}</td>
                <td class="td">${qualification.getDateOfBeginShow()}</td>
                <td class="td">${qualification.getDateOfEndShow()}</td>
                <td class="td">${qualification.getOrganisation()}</td>
                <td class="td"><a href="/qualificationPage/${qualification.getId()}">Информация</a></td>
            </tr>
        </#list>
