...
<!-- NAVBAR -->
<h2 align="center" style="margin-top: 20px">Конференции</h2>
<form method="post">
    ...
    <table style="margin-top: 50px" align="center" class="table">
        ...
        <#list conferences as conference>
            <tr>
                <td class="td">${conference.getName()}</td>
                <td class="td">${conference.getDateOfStartShow()}</td>
                <td class="td">${conference.getCity()}</td>
                <td class="td"><a href="/conferencePage/${conference.getId()}">Информация</a></td>
            </tr>
        </#list>
    </table>
</form>
