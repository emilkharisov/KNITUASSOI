...
<div class="form-style-2">
    <div class="form-style-2-heading"><font color="white"></font>
            Выборка преподователей по стажу
    </div>
    <form method="post" action="/selectByExperience">
        <label for="experience">Введите стаж
            <input class="input-field" id="experienceInput" name="experienceInput">
        </label>
        ...
        <table style="margin-top: 50px" align="center" class="table">
            ...
            <#list workers as worker>
                ...
                <td class="td">${worker.getPosition()}</td>
                    <td class="td">${worker.getDateOfBeginWorkShow()}</td>
                </tr>
            </#list>
        </table>
    </form>
