...
<div style="margin-top: 20px">
    <h2 style="margin-left: 20px">Выгрузка учебных работ</h2>
    <ul class="circle" style="margin-top: 10px">
        <hr class="disck"><li><a href="/getBenefitsByYearPage">Выборка по Учебным пособиям за N год</a></li>
        <hr class="disck"><li><a href="/getBooksByYearPage">Выборка по Учебникам за N год</a></li>
        <hr class="disck"><li><a href="/getMethodologyByYearPage">Выборка по Методическим указаняим за N год</a></li>
    </ul>
    <br>
    <h2 style="margin-left: 20px">Выгрузка научных работ</h2>
    <ul class="circle" style="margin-top: 10px">
        <hr class="disck"><li><a href="/getpatentsByYearPage">Выборка по Патентам за N год</a></li>
    </ul>
</div>
